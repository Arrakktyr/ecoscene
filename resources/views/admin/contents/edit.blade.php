    ...
    <div class="container">
        ...
        <form action="{{ route('admin.content.update', ['id' => $content->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sstm" name="sstm" value="{{ $content->sstm }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180 }'>{{ $content->content }}</textarea>
