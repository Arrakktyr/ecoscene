                ...
                <section class="card">
                    <div class="card-body">
                        <div class="thumb-info mb-3">
                            @if ($user->photo)
                                <img id="profile-photo" src="{{ $user->photo }}" alt="Profile Photo" style="width: 100%;">
                            @else
                            <img id="profile-photo" src="/admpanel/img/!logged-user.jpg" class="rounded img-fluid" alt="{{ $user->name }}">
                            @endif
                                <div id="upload-status" class="mt-3"></div>
                            <div class="thumb-info-title">
                                <span class="thumb-info-inner">{{ $user->name }}</span>
                                <span class="thumb-info-type">{{ $user->getRoleNames()->first() }}</span>
                            </div>
                        </div>
                ...
                <div class="tabs">
                    <div class="tab-content">
                        <div id="overview" class="tab-pane active">
                            <div class="p-3">
                                <h4 class="mb-3" style="font-style:italic">"{{$user->status}}"</h4>
                                <h4 class="mb-3"><i style="color:#009900" class="fas fa-calendar-alt"></i> June, 3, 1994</h4>
                                <h4 class="mb-3"><i style="color:#0088cc" class="fa-solid fa-children"></i> Gemini</h4>
                                <h4 class="mb-3"><i style="color:#d2312d" class="fas fa-map-marker-alt"></i>   Bishkek, Kyrgyzstan</h4>
